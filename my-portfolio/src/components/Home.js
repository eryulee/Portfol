...
export default function Home() {
  return (
    <>
      <div class=" min-h-screen flex items-center justify-center px-16 mb-0 pb-0 ">
        <div class="relative w-full max-w-lg">
          <div class="absolute top-38 -left-18 w-32 h-32 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
      ...
      <div className="min-h: 0 flex flex-col items-center justify-center font-mono mt-0 bg-gray-50 ">
        <h1 className="text-xl font-base font-mono pt-5">Stacks I use:</h1>
        <div className="flex flex-wrap justify-center mt-10">
          {content.stack.tech.map((tech, index) => {
            return (
              <span
                className={`${index % 2 ===0 ? "animate-float":"animate-refloat"} w-20 h-20  mx-4 bg-white shadow-2xl m-4 rounded-full flex items-center p-3`}
              >
